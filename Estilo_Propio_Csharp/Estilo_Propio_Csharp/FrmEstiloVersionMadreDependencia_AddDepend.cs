...
{
    public partial class FrmEstiloVersionMadreDependencia_AddDepend : Form
    {
        #region Variables
        ...
        public FrmEstiloVersionMadreDependencia_AddDepend()
        {
            InitializeComponent();
        }

        private void FrmEstiloVersionMadreDependencia_AddDepend_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void BtnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL += "\n" + string.Format(",@cod_estpro_madre	        ='{0}'", TxtEPMadre.Text);
                strSQL += "\n" + string.Format(",@cod_version_madre  	    ='{0}'", TxtVerMadre.Text);
                strSQL += "\n" + string.Format(",@cod_Estpro_dependiente  	='{0}'", TxtEP.Text);
                strSQL += "\n" + string.Format(",@cod_version_dependiente  	='{0}'", TxtVersion.Text);
