...
namespace Estilo_Propio_Csharp
{
    public class VariablesGenerales
    {
        ...
        //public static string pConnect = "Server=192.168.30.22; Database=SIGE_STN_QA; Integrated Security=SSPI";
        //public static string pConnectSeguridad = "Server=192.168.30.22; Database=SEGURIDAD; Integrated Security=SSPI";
        //public static string pConnectVB6 = ("Provider=SQLOLEDB.1; Persist Security Info=True; Initial Catalog=SIGE_STN_QA; Data Source=192.168.30.22;Integrated Security=SSPI");
        public static string pConnect = "Server=192.168.30.55; Database=SIGE_STN; Integrated Security=SSPI";
        public static string pConnectSeguridad = "Server=192.168.30.55; Database=SEGURIDAD; Integrated Security=SSPI";
        public static string pConnectVB6 = ("Provider=SQLOLEDB.1; Persist Security Info=True; Initial Catalog=SIGE_STN; Data Source=192.168.30.55;Integrated Security=SSPI");
